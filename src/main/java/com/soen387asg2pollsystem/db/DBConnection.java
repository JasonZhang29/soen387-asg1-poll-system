package com.soen387asg2pollsystem.db;
...
public class DBConnection {
    public static String ReadPropertisFile(String p){
        try{
            FileInputStream fis = new FileInputStream("/Users/liuhe/IdeaProjects/soen387-asg2-pollsystem/src/main/resources/database.properties");
